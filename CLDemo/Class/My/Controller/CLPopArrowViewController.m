...
-(void)btnclick
{
    ...
    CLPopArrowView *view=[[CLPopArrowView alloc]initWithOrigin:point Width:200 Height:300 Direction:CLArrowDirectionTopMiddle];//初始化弹出视图的箭头顶点位置point，展示视图的宽度Width，高度Height，Direction以及展示的方向
